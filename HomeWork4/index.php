<?php
$job = [
'job_name' => ['Учитель', 'Маркетолог', 'Художник'],
'job_data' => ['2020-НВ', '2005-2010', '2010-2020'],
'job_desc' => ['Много работы. Просто много', 'Продавал, рекламировал, опять продавал', 'Надоело продавать, пошел рисовать']
]
?>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $job[job_data][0];?></span></h6>
